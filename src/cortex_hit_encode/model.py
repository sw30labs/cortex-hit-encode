...
from cortex_hit_encode.config import FEATURE_EXTRACTORS, RunConfig
from cortex_hit_encode.device import describe_device, resolve_device
...
def load_model(run: RunConfig, *, device: str | None = None):
    ...
    if device == "mps":
        from cortex_hit_encode.patches import allow_mps_extractors, llama_mps_eager
