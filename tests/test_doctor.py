...
from cortex_hit_encode.config import FEATURE_EXTRACTORS, HF_CHECKPOINT_PROBE
from cortex_hit_encode.doctor import FAIL, OK, UNKNOWN, WARN, Check
...
def test_offline_run_skips_network_checks_but_still_reports():
    ...
    assert "feature cache" in names
    assert "hf cache" in names
