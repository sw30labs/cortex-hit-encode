...
from cortex_hit_encode.config import FSAVERAGE5_VERTICES
...
def test_top_regions_pick_plausible_names():
    from cortex_hit_encode.regions import load_region_labels, top_regions_per_tr
...
def test_palette_index_brackets_and_clamps():
    from cortex_hit_encode.spin import palette_index_frac
...
def test_blend_palettes_is_a_lerp():
    from cortex_hit_encode.spin import blend_palettes
...
def test_soft_ramp_fades_where_hard_cut_pops():
    from cortex_hit_encode.render import soft_threshold_cmap
...
def test_energy_curve_is_mean_abs_per_tr():
    from cortex_hit_encode.render import energy_curve
...
def test_ribbon_blits_and_playshead_moves():
    from cortex_hit_encode.render import blit_ribbon, draw_energy_ribbon, energy_curve
...
def test_feather_softens_the_silhouette():
    from cortex_hit_encode.spin import feather_alpha
