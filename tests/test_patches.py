...
from cortex_hit_encode.patches import (
    _is_cpu_whisperx,
...
def test_mps_text_kwargs_are_eager_float32():
    ...
    from cortex_hit_encode.patches import mps_text_from_pretrained_kwargs
...
def test_allow_mps_extractors_is_idempotent():
    ...
    from cortex_hit_encode.patches import allow_mps_extractors
