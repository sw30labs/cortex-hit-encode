...
Writes analysis/report-v0.md. No invented numbers: everything here is
...
RUNS_VOL = Path("/Volumes/DATA/cortex-hit-encode/runs/v0")
...
def main() -> int:
    ...
    out = ROOT / "analysis" / "results-v0.json"
