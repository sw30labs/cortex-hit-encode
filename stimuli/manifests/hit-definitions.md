...
Pick **one** `hit_definition_id` per cohort freeze.

| id | Rule (edit before freeze) |
|---|---|
| `chart-peak-le-20` | Peak position ≤ 20 on a named chart (name the chart + country in cohort notes) |
